...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[scale=0.75]
        % Background (taller for vertical stacking)
        \fill[titleblue!5] (-7, -5) rectangle (7, 5);
        \draw[titleblue!30, thick] (-7, -5) rectangle (7, 5);

        % Title
        \node[text=titleblue, font=\Large\bfseries] at (0, 4) {React Ecosystem Overview};

        % Section 1: Market Position (centered, vertical stack)
        \node[text=titleblue, font=\bfseries] at (0, 2.8) {Market Position};
        \node[text=darkgray, font=\small] at (0, 2.2) {34\% adoption rate};
        \node[text=darkgray, font=\small] at (0, 1.8) {1,008 users in survey};
        \node[text=darkgray, font=\small] at (0, 1.4) {-3.3k TL salary diff.};

        % Separator
        \draw[titleblue!50, thick] (-6.5, 1.0) -- (6.5, 1.0);

        % Section 2: Top Combinations
        \node[text=titleblue, font=\bfseries] at (0, 0.2) {Top Combinations};
        \node[text=darkgray, font=\small] at (0, -0.4) {React Native + Firebase: 99.6k TL};
        \node[text=darkgray, font=\small] at (0, -0.8) {Fullstack + Redux: 91.1k TL};
        \node[text=darkgray, font=\small] at (0, -1.2) {Frontend + Redux: 85.2k TL};

        % Separator
        \draw[titleblue!50, thick] (-6.5, -1.8) -- (6.5, -1.8);

        % Section 3: Work Flexibility
        \node[text=titleblue, font=\bfseries] at (0, -2.6) {Work Flexibility};
        \node[text=darkgray, font=\small] at (0, -3.2) {Frontend: 58.2\% remote};
        \node[text=darkgray, font=\small] at (0, -3.6) {React Native: 59.0\% remote};
        \node[text=darkgray, font=\small] at (0, -4.0) {Strong correlation with flexible work};
    \end{tikzpicture}
